 ...
 * consists of the process ID (key), the number of the cluster (cpu set)
 * allocated to the process and the class of the process.
...
/* Adds a new entry with the specified process ID, allocated cluster and process
