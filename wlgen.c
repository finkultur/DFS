...
//                ,"0 /opt/benchmarks/SPEC2006/benchspec/CPU2006/470.lbm/run/build_base_compsys.0000/ lbm 300 myreference.dat 0 1 ../../data/train/input/100_100_130_cf_b.of"
                , "0 /scratch/cBench/automotive_bitcount/src/ a.out 1125000" // auto_bitcount
                , "0 /scratch/cBench/consumer_jpeg_c/src/ a.out -dct int -progressive -opt -outfile output_large_encode.jpeg ../../consumer_jpeg_data/1.ppm"
                , "0 /scratch/cBench/network_dijkstra/src/ a.out ../../network_dijkstra_data/1.dat"
                , "0 /scratch/cBench/consumer_tiff2bw/src a.out ../../consumer_tiff_data/1.tif output_largebw.tif"
                , "0 /scratch/cBench/consumer_tiff2rgba/src/ a.out -c none ../../consumer_tiff_data/1.tif output_largergba.tif"
                , "0 /scratch/cBench/network_patricia/src/ a.out ../../network_patricia_data/1.udp" 
